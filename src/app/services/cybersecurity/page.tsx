    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Comprehensive protection against evolving cyber threats with AI-powered defense systems.
                </motion.p>
            </div>
        </section>
    );
...
const productivityFeatures = [
    {
        ...
        description: "Real-time threat detection with behavioral analytics, dark web monitoring, and customized threat intelligence feeds.",
    ...
    },
    {
        ...
        description: "Automated scanning, risk-based prioritization, and coordinated patch management across all digital assets.",
        image: "https://framerusercontent.com/images/UgBJAGjjD29VPKkOzaxCyabIMgU.png",
    },
    {
        id: "soc-services",
        title: "24/7 SOC Services",
        description: "Round-the-clock monitoring with AI-driven analytics, expert analysts, and automated incident response capabilities.",
        image: "https://framerusercontent.com/images/rrNtQU2aDjYf4aSs1WeRTIkZ3Ws.png",
    },
    {
        id: "incident-response",
        title: "Rapid Incident Response",
        description: "Emergency response team, digital forensics investigation, and strategic recovery planning to minimize business impact.",
...
const useCaseTabs = [
    ...
    { id: "healthcare", label: "Healthcare Protection" },
    { id: "government", label: "Government &  Defense" },
];

const useCaseContent = {
    financial: {
        title: "Banking & Finance Security",
        description: "Secure transactions, prevent fraud, and ensure regulatory compliance for banks and financial institutions.",
        points: [
    ...
    healthcare: {
        ...
        description: "Protect patient data and medical infrastructure with HIPAA-compliant security solutions.",
        points: [
    ...
    government: {
        ...
        description: "Federal-grade protection for critical infrastructure and government agencies.",
        points: [
            "Critical infrastructure monitoring",
            "Classification-level data protection",
            ...
            >
                ...
                <div className="section-header w-full flex flex-col lg:flex-row justify-between items-start gap-10">
                    ...
                    <div className="flex flex-col gap-8 flex-1">
                        ...
                        >
                            Security applications, one platform
                        </motion.h2>
                    </div>
                    ...
                    >
                        Protect business operations across industries with unified cybersecurity solutions.
                    </motion.p>
                </div>
...
const whyFeatures = [
    {
        ...
        description: "Industry-certified security experts with extensive experience across diverse threat landscapes and regulatory environments.",
    },
    {
        icon: "https://framerusercontent.com/images/hUO59zHqoxPubqUshqfD4pUJeGs.svg",
        title: "Intelligent threat detection",
        description: "AI-powered security tools that learn from emerging threats and adapt protection strategies automatically.",
    },
    {
        icon: "https://framerusercontent.com/images/TySVWNut65QwJpR7GO4QnKD0.svg",
        title: "Regulatory expertise",
        description: "Deep knowledge of industry regulations ensuring your security program meets all compliance requirements.",
    },
];
            ...
            >
                ...
                <div className="why-header" style={{ marginBottom: "60px" }}>
                    ...
                    >
                        ...
                        >
                            Defend your enterprise with intelligent, adaptive security solutions.
                        </motion.p>
                    </div>
                </div>
