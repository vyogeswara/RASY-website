    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Strategic guidance and implementation support for complex technology initiatives and digital transformation.
                </motion.p>
            </div>
        </section>
    );
...
const productivityFeatures = [
    {
        ...
        description: "Design comprehensive security frameworks aligned with business objectives, regulatory requirements, and industry best practices.",
    ...
    },
    {
        ...
        description: "Navigate complex compliance landscapes with expert guidance on standards like GDPR, HIPAA, PCI-DSS, and industry-specific regulations.",
        image: "https://framerusercontent.com/images/UgBJAGjjD29VPKkOzaxCyabIMgU.png",
    },
    {
        id: "ai-strategy",
        title: "Artificial Intelligence Strategy",
        description: "Develop AI roadmaps that align with business goals, identify automation opportunities, and create implementation plans for maximum ROI.",
        image: "https://framerusercontent.com/images/rrNtQU2aDjYf4aSs1WeRTIkZ3Ws.png",
    },
    {
        id: "digital-transformation",
        title: "Transformation Strategy",
        description: "Guide organizations through digital transformation with phased implementation plans, change management, and technology selection.",
...
const useCaseTabs = [
    ...
    { id: "tech-strategy", label: "Technology Strategy" },
    { id: "implementation", label: "Implementation Support" },
];

const useCaseContent = {
    "risk-mgmt": {
        title: "Enterprise Risk Assessment",
        description: "Comprehensive evaluation of technology risks, security vulnerabilities, and compliance gaps with prioritized remediation strategies.",
        points: [
    ...
    "tech-strategy": {
        ...
        description: "Strategic technology planning including infrastructure optimization, cloud migration strategies, and digital innovation roadmaps.",
        points: [
    ...
    implementation: {
        ...
        description: "Hands-on support for technology deployments including project management, vendor coordination, and knowledge transfer.",
        points: [
...
function UseCasesSection() {
    const [activeTab, setActiveTab] = useState("risk-mgmt");
            ...
            >
                ...
                <div className="section-header w-full flex flex-col lg:flex-row justify-between items-start gap-10">
                    ...
                    <div className="flex flex-col gap-8 flex-1">
                        ...
                        >
                            Specialized consulting domains
                        </motion.h2>
                    </div>
                    ...
                    >
                        Expert guidance across critical technology and business areas.
                    </motion.p>
                </div>
...
const whyFeatures = [
    {
        ...
        description: "Access seasoned professionals with extensive experience across cybersecurity, AI, and digital transformation initiatives.",
    },
    {
        icon: "https://framerusercontent.com/images/hUO59zHqoxPubqUshqfD4pUJeGs.svg",
        title: "Proven methodologies",
        description: "Minimize project risks through established frameworks, best practices, and lessons learned from successful implementations.",
    },
    {
        icon: "https://framerusercontent.com/images/TySVWNut65QwJpR7GO4QnKD0.svg",
        title: "Faster time-to-value",
        description: "Achieve business objectives quicker with expert guidance that avoids common pitfalls and optimizes implementation approaches.",
    },
];
            ...
            >
                ...
                <div className="why-header" style={{ marginBottom: "60px" }}>
                    ...
                    >
                        ...
                        >
                            Leverage deep expertise to accelerate transformation and minimize implementation risks.
                        </motion.p>
                    </div>
                </div>
