...
const productivityFeatures = [
    {
        ...
        description: "Professional virtual receptionists providing 24/7 call answering, appointment scheduling, and customer inquiry handling with personalized service.",
        image: "https://framerusercontent.com/images/JAFiHCatbTzsAuqWSmAKNN7zvsE.png",
    },
    {
        id: "branding-creative",
        title: "Strategic Brand Development",
        description: "Comprehensive branding services including logo design, visual identity creation, marketing materials, and brand strategy development.",
        image: "https://framerusercontent.com/images/UgBJAGjjD29VPKkOzaxCyabIMgU.png",
    },
    {
        id: "workflow-automation",
        title: "Process Optimization",
        description: "Analyze and automate business processes to eliminate manual tasks, reduce errors, and improve operational efficiency across departments.",
        image: "https://framerusercontent.com/images/rrNtQU2aDjYf4aSs1WeRTIkZ3Ws.png",
    },
    {
        id: "system-integration",
        title: "Technology Integration",
        description: "Connect disparate systems and applications to create seamless data flow and unified operational visibility.",
...
// ============================================================
const useCaseTabs = [
    { id: "customer-exp", label: "Customer Experience" },
    { id: "operations", label: "Operational Efficiency" },
    { id: "market", label: "Market Presence" },
];

const useCaseContent = {
    "customer-exp": {
        title: "Customer Experience Enhancement",
        description: "Transform customer interactions through professional reception services, automated responses, and seamless communication channels.",
        points: [
    ...
    operations: {
        ...
        description: "Optimize internal processes through workflow automation, system integration, and digital transformation initiatives.",
        points: [
    ...
    market: {
        title: "Brand & Market Development",
        description: "Strengthen market position through professional branding, digital marketing support, and technology-enhanced customer engagement.",
        points: [
...
function UseCasesSection() {
    const [activeTab, setActiveTab] = useState("customer-exp");
        ...
        >
            ...
            >
                ...
                <div className="section-header w-full flex flex-col lg:flex-row justify-between items-start gap-10">
                    ...
                    >
                        Enhance operational efficiency across business functions with integrated technology solutions.
                    </motion.p>
                </div>
...
const whyFeatures = [
    {
        ...
        description: "Present a polished, professional image to customers with expert reception services and consistent branding.",
    },
    {
        icon: "https://framerusercontent.com/images/hUO59zHqoxPubqUshqfD4pUJeGs.svg",
        title: "Streamlined operations",
        description: "Eliminate inefficiencies through automation and integration, allowing staff to focus on high-value activities.",
    },
    {
        icon: "https://framerusercontent.com/images/TySVWNut65QwJpR7GO4QnKD0.svg",
        title: "Market differentiation",
        description: "Stand out in your market with professional branding, efficient processes, and superior customer service.",
    },
];
            ...
            >
                ...
                <div className="why-header" style={{ marginBottom: "60px" }}>
                    ...
                    >
                        ...
                        >
                            Transform operations, enhance customer satisfaction, and drive growth through strategic technology implementation.
                        </motion.p>
                    </div>
                </div>
