...
function HeroSection() {
    return (
        <section className="relative overflow-hidden px-5 pb-16 pt-32 text-center md:pb-[100px] md:pt-[180px]">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                {/* Hero Title */}
                <h1
                    className="mb-5 text-[38px] font-medium leading-[1.1] sm:text-[48px] md:text-[80px]"
                    style={{
                ...
                {/* Hero Subtext */}
                <p
                    className="mx-auto max-w-[500px] text-[16px] md:text-[20px]"
